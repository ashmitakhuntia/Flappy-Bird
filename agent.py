...
class Agent:
    def __init__(self, param_set):
        ...
        with open("parameters.yaml", "r") as f:
            ...
            print("available keys =", all_param_set.keys())
    ...
    def run(self, is_training=True, render=False):
        ...
        if is_training:
            ...
            steps = 0
            self.optimizer = optim.Adam(policy_dqn.parameters(), lr = self.alpha) #learning rate
